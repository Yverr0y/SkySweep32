...
> **LEGACY v0.6.1 DEVKIT — НЕ REV C — НЕ ПОКУПАЙТЕ ДЕТАЛИ ПО ЭТОЙ СТРАНИЦЕ.**
> Generic-модули, распиновка, цены и заявленные функции ниже физически не
> проверены. Точная документация прототипа: [Rev C](https://github.com/bobberdolle1/SkySweep32/tree/master/hardware/rev_c).
